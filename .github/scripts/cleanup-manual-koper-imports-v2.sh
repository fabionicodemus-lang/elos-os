...
begin
  ...
  if v_result.deleted_payables <> 3261
    or v_result.deleted_requests <> 1
    or v_result.deleted_baselines <> 1
    or v_result.deleted_budgets <> 1 then

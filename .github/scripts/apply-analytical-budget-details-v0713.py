...
.analytical-view-toggle {
  white-space: nowrap;
}

.analytical-service-link {
  display: grid;
  gap: 2px;
  color: inherit;
...
.analytical-service-link strong {
  color: var(--elos-primary, #08766c);
}

.analytical-service-link small {
  color: var(--muted, #667773);
  font-size: 10px;
  font-weight: 700;
  opacity: 0;
...
.analytical-service-link:hover small,
.analytical-service-link:focus-visible small {
  opacity: 1;
}

.analytical-detail-row > td {
  padding: 0 !important;
  background: #f4f8f7;
  border-top: 0 !important;
}

.analytical-composition-detail {
  margin: 0 12px 14px;
  padding: 12px;
  border: 1px solid #cfe0dc;
  border-radius: 12px;
  background: #ffffff;
  box-shadow: inset 4px 0 0 #0b7b70;
}

.analytical-composition-detail > header {
  display: flex;
  align-items: center;
...
.analytical-composition-detail > header div {
  display: grid;
  gap: 2px;
}

.analytical-composition-detail > header span {
  color: #52706a;
  font-size: 10px;
  font-weight: 800;
...
.analytical-composition-detail > header strong {
  color: #173d39;
  font-size: 13px;
}

.analytical-composition-detail > header > a,
.analytical-detail-empty a {
  color: #08766c;
  font-size: 12px;
  font-weight: 800;
  text-decoration: none;
...
.analytical-inputs-wrap {
  border: 1px solid #e0eae7;
  border-radius: 10px;
}

.analytical-inputs-table {
  min-width: 1040px;
}

.analytical-inputs-table td:first-child {
  min-width: 270px;
}

.analytical-inputs-table td:first-child strong,
.analytical-inputs-table td:first-child span {
  display: block;
}

.analytical-input-category {
  display: inline-flex;
  align-items: center;
  min-height: 22px;
  padding: 3px 8px;
...
.analytical-input-category.labor {
  background: #fff0d9;
  color: #88520a;
}

.analytical-input-category.equipment {
  background: #edf0f8;
  color: #4d5980;
}

.analytical-input-category.service,
.analytical-input-category.freight {
  background: #f0eafa;
  color: #655080;
}

.analytical-detail-empty {
  display: flex;
  align-items: center;
  gap: 10px;
  padding: 12px;
